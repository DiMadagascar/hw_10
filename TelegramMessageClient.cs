...
namespace HW_10
{
    ...
    class TelegramMessageClient
    {
        ...
        public TelegramMessageClient(MainWindow W, string PathToken = @"D:\Обучение Скил\С Шарп\HW10\token.txt")
        {
        ...
        public static void JsonSerializer(ObservableCollection<MessageLog> BotMessageLog)
        {
